...
<body class="antialiased text-slate-800 font-luxury-body selection:bg-emerald-600 selection:text-white overflow-x-hidden bg-slate-50">
    ...
    <!-- HERO HEADER: IDENTIK DENGAN PACKAGES.BLADE.PHP -->
    ...
    <!-- CONTENT SECTION: GRID 2 KOLOM YANG DINAMIS & SIMETRIS -->
    <section id="digital-concierge" class="py-24 sm:py-36 bg-slate-100 scroll-mt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                ...
                <!-- KOLOM KIRI: FORMULIR INPUT ELEGAN (7 Kolom) -->
                <div class="lg:col-span-7 bg-white border border-slate-200 rounded-2xl p-6 sm:p-10 shadow-xl flex flex-col justify-between" data-aos="fade-right">
                    <div>
                        <h3 class="text-slate-900 font-bold text-lg uppercase tracking-wider font-luxury-title mb-1">Formulir Korespondensi</h3>
                        <p class="text-slate-500 text-xs font-light mb-8">Silakan isi detail rencana Anda secara lengkap, tim Advisor kami akan segera merespons.</p>
                        
                        <form action="#" method="POST" class="space-y-6">
                            @csrf
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-[10px] font-bold text-emerald-700 uppercase tracking-widest mb-2">Nama Lengkap</label>
                                    <input type="text" name="name" required class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-xs font-medium focus:outline-none focus:border-emerald-600 transition duration-300">
                                </div>
                                <div>
                                    <label class="block text-[10px] font-bold text-emerald-700 uppercase tracking-widest mb-2">Nama Perusahaan / Institusi</label>
                                    <input type="text" name="company" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-xs font-medium focus:outline-none focus:border-emerald-600 transition duration-300">
                                </div>
                            </div>

                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-[10px] font-bold text-emerald-700 uppercase tracking-widest mb-2">Alamat Email</label>
                                    <input type="email" name="email" required class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-xs font-medium focus:outline-none focus:border-emerald-600 transition duration-300">
                                </div>
                                <div>
                                    <label class="block text-[10px] font-bold text-emerald-700 uppercase tracking-widest mb-2">Nomor WhatsApp</label>
                                    <input type="tel" name="phone" required class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-xs font-medium focus:outline-none focus:border-emerald-600 transition duration-300">
                                </div>
                            </div>

                            <div>
                                <label class="block text-[10px] font-bold text-emerald-700 uppercase tracking-widest mb-2">Kategori Paket / Rencana Acara</label>
                                <select name="event_type" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-xs font-medium focus:outline-none focus:border-emerald-600 transition duration-300 text-slate-600">
                                    <option value="corporate">Corporate Summit / Business Meeting</option>
                                    <option value="wedding">Royal Wedding Ceremony</option>
                                    <option value="exhibition">Grand Exhibition & Exhibition Hall</option>
                                    <option value="other">Kustom / Acara Lainnya</option>
                                </select>
                            </div>

                            <div>
                                <label class="block text-[10px] font-bold text-emerald-700 uppercase tracking-widest mb-2">Pesan Spesifik & Estimasi Pax</label>
                                <textarea name="message" rows="4" required placeholder="Tulis rincian kebutuhan tanggal acara, total estimasi undangan, dan fasilitas khusus yang Anda inginkan..." class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-xs font-medium focus:outline-none focus:border-emerald-600 transition duration-300"></textarea>
                            </div>

                            <div class="pt-4">
                                <button type="submit" class="w-full bg-gradient-to-r from-emerald-700 to-emerald-800 hover:from-emerald-800 hover:to-emerald-900 text-white font-bold px-10 py-4 rounded-xl text-xs uppercase tracking-widest transition duration-300 shadow-md text-center">
                                    Kirim Permintaan Dokumen Penawaran
                                </button>
                            </div>
                        </form>
                    </div>
                ...
                <!-- KOLOM KANAN: DIREKTORI INFORMASI YANG BERSIH DAN SEIMBANG (5 Kolom) -->
                <div class="lg:col-span-5 flex flex-col justify-between gap-6" data-aos="fade-left">
                    ...
                    <!-- Box Jam Operasional & Jadwal Kunjungan -->
...
<section id="spatial-location" class="py-24 sm:py-36 bg-slate-50 text-slate-900 scroll-mt-20 overflow-hidden relative">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-stretch">
            ...
            <!-- Google Maps (7 Kolom - Warna Original/Cerah) -->
            <div class="lg:col-span-7" data-aos="fade-left">
                <div class="relative w-full h-[350px] sm:h-[480px] bg-white p-2 rounded-3xl border border-slate-200 shadow-[0_10px_40px_rgba(0,0,0,0.04)] overflow-hidden group">
                    <!-- Bingkai Efek Glow Tipis Saat Hover -->
